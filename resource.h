...
#define IDS_OPTION_SELECTOR             5
#define IDS_OPTION_ARRAYTAG             6
#define IDS_OPTION_USEKEY               7
#define IDS_OPTION_OMITVERSIONINFO      8
#define IDS_OPTION_MULTISEP             9
